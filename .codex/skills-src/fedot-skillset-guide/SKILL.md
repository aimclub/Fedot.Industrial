...
description: Choose, combine, and sequence the IndustrialTS team skills for repository work, including pure core extraction, invariant-oriented testing and review, safe configs, integration contracts, typed domain errors, and routing. Use when a task touches several architectural concerns, when onboarding teammates to the skillset, or when deciding which skill should lead a refactor, review, or implementation request in fedot_ind or benchmark/v2.
---
...
Use this skill as the team-level guide for the repository skillset. It explains which specialized skill should lead a task, which companion skills to add, and what order usually keeps refactors small, testable, and aligned with the repository's FP-informed direction.

## Quick Start

1. Read [skill-catalog.md](references/skill-catalog.md) to see the role of each repository skill.
...
- integrating benchmark adapters, optional baselines, or model-wrapper contracts
