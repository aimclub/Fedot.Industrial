...
UCR_DATASETS = ()
STAGE1_OUTPUT_DIR = PROJECT_ROOT / "benchmark" / "results" / "kernel_learning" / f"ucr_two_stage_{EXPERIMENT_DATE}"
STAGE2_OUTPUT_DIR = PROJECT_ROOT / "benchmark" / "results" / \
                    "kernel_learning" / f"ucr_two_stage_optim_{EXPERIMENT_DATE}"
