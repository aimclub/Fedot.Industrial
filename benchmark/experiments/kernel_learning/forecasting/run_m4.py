...
from benchmark.experiments.kernel_learning.controls import read_csv_env, read_positive_int_env
...
config = BenchmarkSuiteConfig(
    ...
    artifact_spec=ArtifactSpec(
        output_dir=f"benchmark/results/kernel_learning/forecasting_suite_{EXPERIMENT_DATE}",
        persist_on_run=True,
    ),
    run_spec=RunSpec(
