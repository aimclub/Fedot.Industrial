...
def read_tsv(file_name: str):
    df_train = pd.read_csv(
        r'D:\РАБОТЫ РЕПОЗИТОРИИ\Репозитории\IndustrialTS\data\{}\{}_TRAIN.tsv'.format(file_name, file_name).format(file_name, file_name),
    ...
    df_test = pd.read_csv(
        r'D:\РАБОТЫ РЕПОЗИТОРИИ\Репозитории\IndustrialTS\data\{}\{}_TEST.tsv'.format(file_name, file_name).format(file_name, file_name),
