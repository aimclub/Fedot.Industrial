...
- показать, как forecasting связан с `benchmark/industrial`;
...
- [radical_forecasting_refactor_plan.md](../../pr_plans/radical_forecasting_refactor_plan.md)
- [forecasting_phase_2_roadmap.md](../../pr_plans/forecasting_phase_2_roadmap.md)
- [forecasting_suite_workflow.md](../../benchmark_v2/forecasting_suite_workflow.md)
- [forecasting_developer_architecture.md](2.Концептуальная схема разработанной архитектуры модулья прогнозирования)
...
flowchart LR
    ...
    F --> G["stage tuning"]
    F --> H["benchmark/industrial artifacts"]
...
- [benchmark/industrial/core.py](../../benchmark/industrial/core.py)
...
1. [core.py](../../benchmark/industrial/core.py)
2. [forecasting.py](../../benchmark/industrial/forecasting.py)
3. [analytics.py](../../benchmark/industrial/analytics.py)
4. [verbosity.py](../../benchmark/industrial/verbosity.py)
...
1. `build_model_adapter(...)` в [forecasting.py](../../benchmark/industrial/forecasting.py)
2. `ModelSpec.params`
...
Если модель умеет `get_diagnostics()`, это ещё не значит, что `benchmark/industrial` их увидит. Нужно проверить adapter path и
serialization.
...
6. [benchmark/industrial/forecasting.py](../../benchmark/industrial/forecasting.py)
...
2. [core.py](../../benchmark/industrial/core.py)
3. [forecasting.py](../../benchmark/industrial/forecasting.py)
4. [analytics.py](../../benchmark/industrial/analytics.py)
...
- [forecasting_runtime_api_reference.md](./4. Обзор этапов процесса прогнозирования в новой архитектурной реализации)
- [forecasting_models_reference.md](./3.Обзор реализаций текущих моделей прогнозирования)
- [benchmark_v2_forecasting_guide.md](./5.Модуль бенчмаркинга для валидации моделей прогнозирования)
- [forecasting_branch_development_history.md](./0.Хронология изменения в кодовой базе)
- [forecasting_merge_artifact_policy.md](./6.Правила формирования PR и коммитов)
...
- начать с `benchmark/industrial/forecasting.py`;
...
- использовать `benchmark/industrial/result_visualization.py`;
- для M4 lagged debug path запускать `benchmark/industrial/examples/benchmark/visualize_m4_lagged_results_240426.py`;
...
Подробное правило зафиксировано в [forecasting_merge_artifact_policy.md](./6.Правила формирования PR и коммитов).
