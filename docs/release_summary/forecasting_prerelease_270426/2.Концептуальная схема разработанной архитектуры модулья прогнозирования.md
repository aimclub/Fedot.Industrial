...
flowchart LR
    ...
    F1["benchmark/industrial/core.py"] -.-> F
    F2["benchmark/industrial/forecasting.py"] -.-> F
    F3["benchmark/industrial/analytics.py"] -.-> F
```
...
## 7. Архитектура `benchmark/industrial`
...
flowchart TD
    ...
    B -->|"suite / artifacts"| G["benchmark/industrial"]
    ...
    G --> S["benchmark/industrial/forecasting.py"]
    G --> T["benchmark/industrial/analytics.py"]
```
...
flowchart LR
    ...
    C --> D["benchmark/industrial/forecasting.py"]
    D --> E["analytics.py"]
```
...
- **benchmark/industrial** превращает всё это в records, artifacts и сравнимые результаты.
