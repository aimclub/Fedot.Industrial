...
for index, layer in enumerate([docnn_model_copy.linear1, docnn_model_copy.linear2, docnn_model_copy.linear3]):
...
assert torch.equal(docnn_model_copy.linear1.weight, original_weights["linear1.weight"])
