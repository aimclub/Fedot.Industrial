...
def run_pdl_uni_classification(output_dir=None) -> dict:
    result = run_classification_benchmark(output_dir=output_dir)
    return {"scenario": "pdl_uni_classification", "benchmark": result_summary(result)}


if __name__ == "__main__":
    print(run_pdl_uni_classification())
