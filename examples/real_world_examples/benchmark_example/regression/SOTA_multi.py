...
from fedot_ind.core.repository.config_repository import (DEFAULT_COMPUTE_CONFIG, DEFAULT_REG_INDUSTRIAL_CONFIG,
                                                         DEFAULT_REG_AUTOML_CONFIG, DEFAULT_REG_LEARNING_CONFIG)
...
API_CONFIG = {'industrial_config': DEFAULT_REG_INDUSTRIAL_CONFIG,
