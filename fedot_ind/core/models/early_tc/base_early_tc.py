...
class BaseETC(ClassifierMixin, BaseEstimator):
    def __init__(self, params: Optional[OperationParameters] = None):    
        ...
        self.interval_percentage = params.get('interval_percentage', 10) # rewrite as interval_length
        self.acceptance_threshold = params.get('acceptance_threshold', 5)
        self.hm_shift_to_acc = params.get('hm_shift_to_acc', 1.)
        assert self.acceptance_threshold < self.interval_percentage, 'Not enough checkpoints for prediction proof'
    ...
    def fit(self, X, y=None):
        ...
        self._best_estimator_idx = np.argmax(self._score(X, y, self.hm_shift_to_acc))
    ...
    def _predict(self, X,):
        ...
        predicted_probas, predicted_labels = zip(
