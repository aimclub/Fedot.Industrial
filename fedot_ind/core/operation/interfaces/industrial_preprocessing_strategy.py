...
class MultiDimPreprocessingStrategy(EvaluationStrategy):
    ...
    def _sklearn_compatible_prediction(
        ...
        predict_method = curry(1)(lambda data: trained_operation.predict(
            data) if self.operation_condition.is_regression_of_forecasting_task else trained_operation.predict_for_fit(data))
