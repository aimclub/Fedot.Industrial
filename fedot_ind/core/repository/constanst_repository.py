...
class BenchmarkDatasets(Enum):
    ...
    M4_FORECASTING_BENCH_SMALL = ['D1002', 'D1019', 'D1032', 'D1101', 'D1104', 'D1124', 'D1162', 'D1170', 'D1204', 'D1219',
                            'M10641', 'M1080', 'M11230', 'M11654', 'M11779', 'M11806', 'M12209', 'M12241', 'M12422', 'M12452',
                            'Q10070', 'Q10262', 'Q10292', 'Q10466', 'Q10598', 'Q10665', 'Q1069', 'Q10743', 'Q10800', 'Q10881', 
                            'W103', 'W105', 'W106', 'W107', 'W109', 'W10', 'W110', 'W111', 'W113', 'W116',                           
                            'Y10907', 'Y10908', 'Y11041', 'Y1107', 'Y11106', 'Y11116', 'Y11430', 'Y13802', 'Y14055', 'Y14324']
    M4_FORECASTING_BENCH_SMALL_DAILY = ['D1002', 'D1019', 'D1032', 'D1101', 'D1104', 'D1124', 'D1162', 'D1170', 'D1204', 'D1219']
    M4_FORECASTING_BENCH_SMALL_MONTHLY = ['M10641', 'M1080', 'M11230', 'M11654', 'M11779', 'M11806', 'M12209', 'M12241', 'M12422', 'M12452']
    M4_FORECASTING_BENCH_SMALL_QUARTERLY = ['Q10070', 'Q10262', 'Q10292', 'Q10466', 'Q10598', 'Q10665', 'Q1069', 'Q10743', 'Q10800', 'Q10881']
    M4_FORECASTING_BENCH_SMALL_WEEKLY = ['W103', 'W105', 'W106', 'W107', 'W109', 'W10', 'W110', 'W111', 'W113', 'W116']
    M4_FORECASTING_BENCH_SMALL_YEARLY = ['Y10907', 'Y10908', 'Y11041', 'Y1107', 'Y11106', 'Y11116', 'Y11430', 'Y13802', 'Y14055', 'Y14324']
    ...
    MONASH_FORECASTING_BENCH = ['australian_electricity_demand', 'bitcoin', 'car_parts', 'cif_2016', 'covid_deaths',
                                'dominick', 'electricity_hourly', 'electricity_weekly', 'fred_md', 'hospital',
                                'kaggle_web_traffic', 'kdd_cup', 'm1_monthly', 'm1_quarterly', 'm1_yearly', 'm3_monthly',
                                'm3_quarterly', 'm3_yearly', 'm4_daily', 'm4_hourly', 'm4_monthly', 'm4_quarterly',
                                'm4_weekly', 'm4_yearly', 'nn5_daily', 'nn5_weekly', 'pedestrian_counts', 'rideshare',
                                'saugeen_river_flow', 'solar_10_minutes', 'solar_weekly', 'sunspot', 'temperature_rain', 
                                'tourism_monthly', 'tourism_quarterly', 'tourism_yearly', 'traffic_hourly', 'traffic_weekly',
                                'us_births', 'vehicle_trips', 'weather']
    MONASH_FORECASTING_LENGTH = {'australian_electricity_demand': 336, 'bitcoin': 30, 'car_parts': 12, 'cif_2016': 12,
                                'covid_deaths': 30, 'dominick': 8, 'electricity_hourly': 168, 'electricity_weekly': 8,
                                'fred_md': 12, 'hospital': 12, 'kaggle_web_traffic': 8, 'kdd_cup': 168, 'm1_monthly': 18,
                                'm1_quarterly': 8, 'm1_yearly': 6, 'm3_monthly': 18, 'm3_quarterly': 8, 'm3_yearly': 6,
                                'm4_daily': 14, 'm4_hourly': 48, 'm4_monthly': 18, 'm4_quarterly': 8, 'm4_weekly': 13,
                                'm4_yearly': 6, 'nn5_daily': 56, 'nn5_weekly': 8, 'pedestrian_counts': 24, 'rideshare': 168,
                                'saugeen_river_flow': 30, 'solar_10_minutes': 1008, 'solar_weekly': 5, 'sunspot': 30,
                                'temperature_rain': 30, 'tourism_monthly': 24, 'tourism_quarterly': 8, 'tourism_yearly': 4,
                                'traffic_hourly': 168, 'traffic_weekly': 8, 'us_births': 30, 'vehicle_trips': 30, 'weather': 30}
    UNI_CLF_BENCH = [
        "ACSF1",
        "Adiac",
        "ArrowHead",
