...
from our_approach.api.utils.path_lib import DEFAULT_PATH_RESULTS as default_path_to_save_results
from our_approach.core.architecture.abstraction.decorators import DaskServer
from our_approach.core.architecture.pipelines.classification import SklearnCompatibleClassifier
from our_approach.core.architecture.preprocessing.data_convertor import ApiConverter
from our_approach.core.architecture.settings.computational import BackendMethods
from our_approach.core.operation.transformation.splitter import TSTransformer
from our_approach.core.optimizer.IndustrialEvoOptimizer import IndustrialEvoOptimizer
from our_approach.core.repository.constanst_repository import \
    FEDOT_GET_METRICS, FEDOT_TUNING_METRICS, \
    FEDOT_API_PARAMS, FEDOT_TUNER_STRATEGY, fedot_init_assumptions
from our_approach.core.repository.industrial_implementations.abstract import build_tuner
...
from our_approach.tools.explain.explain import PointExplainer, RecurrenceExplainer
from our_approach.tools.synthetic.anomaly_generator import AnomalyGenerator
from our_approach.tools.synthetic.ts_generator import TimeSeriesGenerator

warnings.filterwarnings("ignore")


class MainClass(Fedot):
    ...
    Example:
        First, configure experiment and instantiate FedotIndustrial class::
            ...
            from our_approach.api.main import FedotIndustrial
