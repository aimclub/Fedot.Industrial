...
from our_approach.core.architecture.abstraction.client import use_default_fedot_client
from our_approach.core.ensemble.kernel_ensemble import KernelEnsembler
from our_approach.core.ensemble.random_automl_forest import RAFEnsembler
from our_approach.core.operation.decomposition.matrix_decomposition.column_sampling_decomposition import CURDecomposition
from our_approach.core.repository.constanst_repository import BATCH_SIZE_FOR_FEDOT_WORKER, FEDOT_WORKER_NUM, \
