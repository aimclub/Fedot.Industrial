...
from our_approach.api.utils.path_lib import DS_INFO_PATH, PROJECT_PATH
...
class ResultsPicker:
    ...
    Examples:
        >>> from our_approach.core.architecture.postprocessing.results_picker import ResultsPicker
