...
from our_approach.core.architecture.abstraction.decorators import convert_to_3d_torch_array
...
from our_approach.core.operation.decomposition.matrix_decomposition.power_iteration_decomposition import RSVDDecomposition
