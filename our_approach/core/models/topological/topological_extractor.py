...
from our_approach.core.models.base_extractor import BaseExtractor
from our_approach.core.models.topological.topofeatures import PersistenceDiagramsExtractor, TopologicalFeaturesExtractor
from our_approach.core.operation.transformation.data.point_cloud import TopologicalTransformation
from our_approach.core.repository.constanst_repository import PERSISTENCE_DIAGRAM_EXTRACTOR, PERSISTENCE_DIAGRAM_FEATURES
...
class TopologicalExtractor(BaseExtractor):
    ...
    Example:
        To use this operation you can create pipeline as follows::
            ...
            from our_approach.api.utils.input_data import init_input_data
