...
from our_approach.core.operation.dummy.dummy_operation import DummyOperation
from our_approach.core.operation.filtration.feature_filtration import FeatureFilter
