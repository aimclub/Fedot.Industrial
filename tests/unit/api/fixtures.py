...
def multivariate_time_series_df():
    return pd.DataFrame(np.random.randn(NUM_SAMPLES, 3, SERIES_LENGTH).tolist())
...
def test_example(univariate_time_series_np, univariate_time_series_df, multivariate_time_series_np,
                 multivariate_time_series_df, uni_classification_labels_np, multi_classification_labels_df,
                 regression_target_np, regression_target_df):
