...
from benchmark.v2.classification import build_classification_dataset_adapter
from benchmark.v2.regression import build_regression_dataset_adapter
...
def test_legacy_tsc_can_delegate_to_v2(tmp_path: Path) -> None:
...
def test_legacy_tser_can_delegate_to_v2(tmp_path: Path) -> None:
