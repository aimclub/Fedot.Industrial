...
if __name__ == '__main__':
    ...
    # # _ = 1
    # # target = pd.read_csv(r'C:\Users\user\Desktop\Репозитории\Huawei_AutoML\experiments\classification\target.csv',header=None,names=['real'])
    # # predictions = pd.read_csv(
    # #     r'C:\Users\user\Desktop\Репозитории\Huawei_AutoML\experiments\classification\predictions.csv',header=None,names=['pred'])
    # # proba_redictions = pd.read_csv(
    # #     r'C:\Users\user\Desktop\Репозитории\Huawei_AutoML\experiments\classification\proba_predictions.csv', header=None,sep=',')
